...
jQuery(document).ready(function() {
	...
	if (typeof fs_params == 'undefined') {
		fs_params = {animation: 'fade', controlNav: true, directionNav: true, slideshow: false, pauseOnAction: true, pauseOnHover: false, animationSpeed: 300, slideshowSpeed: 5000};
	}
	

	if (typeof fs_params_homepage == 'undefined') {
		fs_params_homepage = {animation: 'fade', controlNav: false, directionNav: true, slideshow: true, pauseOnAction: false, pauseOnHover: true, animationSpeed: 1500, slideshowSpeed: 5000};
	}
